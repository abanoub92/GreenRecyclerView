...
/**
 * MaterialColor is a class with one method, used to color the ViewHolders in
...
public class MaterialColor {
     ...
     * {@link com.abanoub.unit.greenrecyclerview.NumberViewHolder}
     ...
     * {@link com.abanoub.unit.greenrecyclerview.NumberViewHolder}'s will be
     ...
     * was created.
     */
    public static int getBackgroundForViewHolder(Context context, int instanceNum){
        switch (instanceNum){
            case 0:
